    ...
    <div className="min-h-screen-safe flex flex-col items-center bg-cream px-4 py-12">
      ...
      <div className="w-full max-w-sm">
        <div className="card p-8 shadow-sm">
          <h2 className="mb-6 text-center font-serif text-2xl text-espresso">Join the Atelier</h2>
          ...
          <form onSubmit={(e) => { e.preventDefault(); handleSubmit(); }} className="space-y-5">
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium uppercase tracking-widest text-espresso" htmlFor="email">
                Email Address
              </label>
              <input
                id="email"
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium uppercase tracking-widest text-espresso" htmlFor="password">
                Password
              </label>
            ...
            <div className="space-y-1.5">
              <label className="block text-xs font-medium uppercase tracking-widest text-espresso" htmlFor="confirmPassword">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
            ...
            <button type="submit" className="btn-primary btn-lg w-full" disabled={isLoading}>

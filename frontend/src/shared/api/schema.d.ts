...
export interface paths {
    ...
    "/wardrobe/items/{id}/status": {
        ...
        head?: never;
        /**
         * Update a clothing item's wearability status
         * @description Manually set an item's status (e.g. mark it as in the laundry). The accept-outfit flow sets 'worn' automatically; this lets the user drive the other transitions.
         */
        patch: {
            parameters: {
                query?: never;
